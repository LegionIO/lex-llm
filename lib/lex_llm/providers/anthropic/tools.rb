    ...
    class Anthropic
      ...
      module Tools
        ...
        def format_tool_call(msg)
          return { role: 'assistant', content: msg.content.value } if msg.content.is_a?(LexLLM::Content::Raw)
        ...
        def format_tool_result(msg)
          {
            role: 'user',
            content: msg.content.is_a?(LexLLM::Content::Raw) ? msg.content.value : [format_tool_result_block(msg)]
          }
        end
        ...
        def function_for(tool)
          input_schema = tool.params_schema ||
                         LexLLM::Tool::SchemaDefinition.from_parameters(tool.parameters)&.json_schema
          ...
          LexLLM::Utils.deep_merge(declaration, tool.provider_params)
        end
