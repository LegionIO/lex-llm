    ...
    module Llm
      ...
      module ProviderSettings
        ...
        def build(family:, instance: {}, enabled: true, discovery: {}, instances: {}, fleet: nil, gateways: nil, # rubocop:disable Metrics/ParameterLists
          ...
          Utils.deep_merge(
            Legion::Extensions::Llm.default_settings,
            {
              ...
              discovery: Utils.deep_merge({ enabled: true, interval_seconds: 300 }, discovery || {}),
              instances: Utils.deep_merge(
                {
                  default: Utils.deep_merge(
        ...
        def infer_tier_from_endpoint(url)
          ...
          Legion::Extensions::Llm::Utils.localhost_url?(url) ? :local : :direct
        end
      end
    end
  end
