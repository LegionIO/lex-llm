...
RSpec.describe LexLLM::Provider do
  describe '.register' do
    it 'registers provider configuration options on Configuration' do
      ...
      begin
        ...
        config = LexLLM::Configuration.new
        ...
        option_keys.each do |key|
          LexLLM::Configuration.send(:option_keys).delete(key)
          LexLLM::Configuration.send(:defaults).delete(key)
          LexLLM::Configuration.class_eval do
