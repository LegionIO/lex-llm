...
require 'spec_helper'
require 'fileutils'
require 'generators/lex_llm/tool/tool_generator'
require_relative '../../support/generator_test_helpers'

RSpec.describe LexLLM::Generators::ToolGenerator, :generator, type: :generator do
  ...
  it 'creates a tool class and tool call/result partials' do
    within_test_app(app_path) do
      output, status = run_rails_generate('lex_llm:tool', 'Weather')
      ...
      expect(tool_class).to include('class WeatherTool < LexLLM::Tool')
