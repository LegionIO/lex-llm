...
require 'spec_helper'
require 'fileutils'
require 'generators/lex_llm/chat_ui/chat_ui_generator'
require_relative '../../support/generator_test_helpers'

RSpec.describe LexLLM::Generators::ChatUIGenerator, :generator, type: :generator do
  ...
  def expect_messages_helper_content(path)
    ...
    expect(messages_helper).to include('LexLLM.models.find(LexLLM.config.default_model).label')
