...
require 'spec_helper'
require 'fileutils'
require 'generators/lex_llm/install/install_generator'
require_relative '../../support/generator_test_helpers'

RSpec.describe LexLLM::Generators::InstallGenerator, :generator, type: :generator do
  ...
  describe 'with default model names' do
    ...
    it 'creates initializer file' do
      within_test_app(app_path) do
        expect(File.exist?('config/initializers/lex_llm.rb')).to be true
