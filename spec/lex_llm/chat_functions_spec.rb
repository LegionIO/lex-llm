...
RSpec.describe LexLLM::Chat do
  ...
  describe '#with_tool' do
    it 'adds tools regardless of model capabilities' do
      ...
      model = LexLLM.models.find('gpt-4.1-nano')
  ...
  describe '#with_tools' do
    it 'adds multiple tools at once' do
      ...
      tool1 = Class.new(LexLLM::Tool) do
        def name = 'tool1'
      end

      tool2 = Class.new(LexLLM::Tool) do
        def name = 'tool2'
      end
    ...
    it 'replaces all tools when replace: true' do
      ...
      tool3 = Class.new(LexLLM::Tool) do
        def name = 'tool3'
      end
