...
RSpec.describe LexLLM::Providers::Gemini::Tools do
  ...
  describe '#format_tool_call' do
    it 'outputs a functionCall part for each tool call and preserves assistant text' do
      tool_calls = {
        'a' => LexLLM::ToolCall.new(id: 'a', name: 'weather', arguments: { 'latitude' => '52.5200' }),
        'b' => LexLLM::ToolCall.new(id: 'b', name: 'best_language_to_learn', arguments: {})
      }
      message = LexLLM::Message.new(role: :assistant, content: 'Working on it...', tool_calls:)
