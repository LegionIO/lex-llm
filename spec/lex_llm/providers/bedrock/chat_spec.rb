...
RSpec.describe LexLLM::Providers::Bedrock::Chat do
  ...
  describe '.render_payload' do
    let(:model) do
      instance_double(LexLLM::Model::Info,
    ...
    context 'when schema is provided' do
      ...
      it 'uses schema name and inner schema' do
        custom_schema = LexLLM::Utils.deep_dup(schema)
      ...
      it 'does not mutate the original schema' do
        original = LexLLM::Utils.deep_dup(schema)
