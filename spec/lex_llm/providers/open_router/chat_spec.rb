...
RSpec.describe LexLLM::Providers::OpenRouter::Chat do
  describe '.render_payload' do
    let(:model) { instance_double(LexLLM::Model::Info, id: 'anthropic/claude-haiku-4.5') }
    let(:messages) { [LexLLM::Message.new(role: :user, content: 'Hello')] }
