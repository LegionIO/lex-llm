...
RSpec.describe LexLLM::Providers::Anthropic::Media do
  describe '.format_content' do
    let(:pdf_path) { File.join('spec', 'fixtures', 'sample.pdf') }

    it 'serializes LexLLM::Content with attachments into Anthropic blocks' do
      content = LexLLM::Content.new('Summarize this', pdf_path)
