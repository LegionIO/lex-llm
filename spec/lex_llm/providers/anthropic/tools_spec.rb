...
RSpec.describe LexLLM::Providers::Anthropic::Tools do
  let(:tools) { described_class }

  describe '.format_tool_call' do
    let(:msg) do
      instance_double(LexLLM::Message,
                      content: 'Some content',
                      tool_calls: {
                        'tool_123' => instance_double(LexLLM::ToolCall,
                                                      id: 'tool_123',
                                                      name: 'test_tool',
    ...
    it 'formats messages with multiple tool calls correctly' do
      tool_calls = {
        'tool_1' => LexLLM::ToolCall.new(id: 'tool_1', name: 'dice_roll', arguments: {}),
        'tool_2' => LexLLM::ToolCall.new(id: 'tool_2', name: 'dice_roll', arguments: {}),
        'tool_3' => LexLLM::ToolCall.new(id: 'tool_3', name: 'dice_roll', arguments: {})
      }

      msg = LexLLM::Message.new(
        role: :assistant,
  ...
  describe '.format_tool_result' do
    ...
    it 'uses a placeholder when the tool returns no content' do
      msg = instance_double(LexLLM::Message,
                            tool_call_id: 'tool_123',
                            content: '')
